...
export default function Home() {
  ...
  return (
    <header className="mx-auto flex h-full w-1/2 gap-12 py-32">
      <div className="flex w-fit flex-col items-center gap-8">
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-1 text-lg">
            <p>Built for those quick projects {':)'}</p>
            <p>
              Get started by editing{' '}
              <code className="select-none rounded-sm bg-neutral-200 px-2 py-1 text-sm dark:bg-neutral-700">page.tsx</code>
            </p>
          </div>
          <div className="flex items-center gap-4 text-sm">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-1 rounded-md bg-violet-800 px-6 py-2 text-violet-200 hover:bg-violet-900 dark:bg-violet-300 dark:text-violet-800 hover:dark:bg-violet-400"
            >
      ...
      <div className="flex w-full flex-col items-center gap-12 py-20">
        <a href="https://nextjs.org/" target="_blank" rel="noreferrer">
          <Image
            ...
            height={61}
            width={300}
            className={`${resolvedTheme === 'light' ? 'hidden' : 'block'}`}
          />
          <Image
            alt="Next.js Logo"
        ...
        <a href="https://www.typescriptlang.org/" target="_blank" rel="noreferrer" className="flex items-center gap-2">
          <svg className="h-14 w-14" fill="none" height="128" viewBox="0 0 128 128" width="128" xmlns="http://www.w3.org/2000/svg">
            <rect className="fill-[#191c1e] dark:fill-white" height="128" rx="6" width="128" />
            <path
              clip-rule="evenodd"
              ...
              className="fill-white dark:fill-[#191c1e]"
              fill-rule="evenodd"
            />
          </svg>
          <p className="select-none text-5xl font-semibold text-[#191c1e] dark:text-white">
